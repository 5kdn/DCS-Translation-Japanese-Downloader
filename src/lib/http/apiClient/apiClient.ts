...
// @ts-ignore
import { CreateIssueRequestBuilderRequestsMetadata, type CreateIssueRequestBuilder } from './createIssue/index.js';
// @ts-ignore
...
export interface ApiClient extends BaseRequestBuilder<ApiClient> {
    /**
     * The createIssue property
     */
    get createIssue(): CreateIssueRequestBuilder;
    /**
...
export const ApiClientNavigationMetadata: Record<Exclude<keyof ApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    createIssue: {
        requestsMetadata: CreateIssueRequestBuilderRequestsMetadata,
    },
    createPr: {
