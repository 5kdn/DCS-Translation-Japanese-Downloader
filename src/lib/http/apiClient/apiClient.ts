...
// @ts-ignore
import { IssueRequestBuilderNavigationMetadata, type IssueRequestBuilder } from './issue/index.js';
// @ts-ignore
import { TreeRequestBuilderRequestsMetadata, type TreeRequestBuilder } from './tree/index.js';
// @ts-ignore
import { TreeMetadataRequestBuilderNavigationMetadata, type TreeMetadataRequestBuilder } from './treeMetadata/index.js';
// @ts-ignore
...
export interface ApiClient extends BaseRequestBuilder<ApiClient> {
    ...
    /**
     * The treeMetadata property
     */
    get treeMetadata(): TreeMetadataRequestBuilder;
}
/**
...
export const ApiClientNavigationMetadata: Record<Exclude<keyof ApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    issue: {
        navigationMetadata: IssueRequestBuilderNavigationMetadata,
    },
    tree: {
        requestsMetadata: TreeRequestBuilderRequestsMetadata,
    },
    treeMetadata: {
        navigationMetadata: TreeMetadataRequestBuilderNavigationMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
